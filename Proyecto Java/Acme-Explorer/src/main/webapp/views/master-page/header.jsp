	...
	<ul id="jMenu">
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="sponsorship/sponsor/list.do"><spring:message
								code="master.page.sponsorship.sponsor.list" /></a></li>
					<li><a href="messageFolder/sponsor/list.do"><spring:message
								code="master.page.messageFolder.list" /></a></li>
					<li><a href="trip/sponsor/list.do"><spring:message
								code="master.page.manager.list.trips" /></a></li>
					<li><a href="message/sponsor/send.do"><spring:message
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="auditRecord/auditor/list.do"><spring:message
								code="master.page.auditRecord.auditor.list" /></a></li>
					<li><a href="note/auditor/list.do"><spring:message
								code="master.page.note.auditor.list" /></a></li>
					<li><a href="messageFolder/auditor/list.do"><spring:message
								code="master.page.messageFolder.list" /></a></li>
					<li><a href="trip/auditor/list.do"><spring:message
								code="master.page.auditor.list.trips" /></a>
					<li><a href="message/auditor/send.do"><spring:message
								code="master.page.message.send" /></a></li>
				</ul></li>
			<li><a href="trip/list.do"><spring:message
						code="master.page.trips" /></a></li>
		...
		<security:authorize access="hasRole('EXPLORER')">
			<li><a class="fNiv"><spring:message
				...
				<ul>
					<li class="arrow"></li>
					<li><a href="applicationFor/explorer/list.do"><spring:message
								code="master.page.explorer.list.applicationFor" /></a></li>
					<li><a href="trip/explorer/list-not-apply.do"><spring:message
								code="master.page.explorer.list.not.apply.trips" /></a></li>
					<li><a href="explorer/edit.do"><spring:message
								code="master.page.explorer.edit" /></a></li>
					<li><a href="story/explorer/list.do"><spring:message
								code="master.page.explorer.stories" /></a></li>
					<li><a href="contactsEmergency/explorer/list.do"><spring:message
								code="master.page.explorer.contactEmergency" /></a></li>
					<li><a href="trip/explorer/listTrip.do"><spring:message
								code="master.page.explorer.trips.stories" /></a></li>
					<li><a href="messageFolder/explorer/list.do"><spring:message
								code="master.page.messageFolder.list" /></a></li>
		...
		<security:authorize access="hasRole('RANGER')">
			<li><a class="fNiv"><spring:message
				...
				<ul>
					<li class="arrow"></li>
					<li><a href="rangerProfile/ranger/edit.do"><spring:message
								code="master.page.rangerProfile.ranger.edit" /></a></li>
					<li><a href="curricula/ranger/display.do"><spring:message
								code="master.page.curricula.ranger.display" /></a></li>
					<li><a href="messageFolder/ranger/list.do"><spring:message
								code="master.page.messageFolder.list" /></a></li>
					<li><a href="message/ranger/send.do"><spring:message
								code="master.page.message.send" /></a></li>
				</ul></li>
			<li><a href="trip/list.do"><spring:message
						code="master.page.trips" /></a></li>
			...
			<li><a class="fNiv "><spring:message
				...
				<ul>
					...
					<li><a href="manager/edit.do"><spring:message
								code="master.page.sponsor.edit" /></a></li>
					<li><a href="applicationFor/manager/list.do"><spring:message
								code="master.page.manager.list.applicationFor" /></a></li>
					<li><a href="trip/manager_/list.do"><spring:message
								code="master.page.manager.list.trips" /></a></li>
					<li><a href="messageFolder/manager/list.do"><spring:message
								code="master.page.messageFolder.list" /></a></li>
					<li><a href="survivalClass/manager/list.do"><spring:message
								code="master.page.survivalClass.manager" /></a></li>
					<li><a href="note/manager/list.do"><spring:message
								code="master.page.note.manager.list" /></a></li>
		...
		<security:authorize access="isAnonymous()">
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					<li><a href="rangerProfile/create.do"><spring:message
								code="master.page.rangerProfile.create" /></a></li>
					<li><a href="explorerProfile/create.do"><spring:message
								code="master.page.explorerProfile.create" /></a></li>
				</ul></li>
		</security:authorize>
