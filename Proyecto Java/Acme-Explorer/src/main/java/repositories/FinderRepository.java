...
//
// @Query("select t from Trip t where (t.ticker like %?1% or t.title like %?1% or t.description like %?1%) and (t.price>?2 and t.price<?3) and (t.startDate < '?4' and t.finishDate > '?5')")
